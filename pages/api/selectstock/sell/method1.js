...
export default async (req, res) => {
  ...
  if (jsonFiles.indexOf(saveFile) !== -1) {
    ...
    Keys.forEach((key) => {
      ...
      let william9 = williams.getWilliams(list[key].slice(-9));
      let william18 = williams.getWilliams(list[key].slice(-18));
      let beforeWilliam9 = williams.getWilliams(list[key].slice(-10, -1));
      let beforeWilliam18 = williams.getWilliams(list[key].slice(-19, -1));
      ...
      if (
        ...
        let field = {
          ...
          William9: william9,
          William18: william18,
          beforeWilliam9: beforeWilliam9,
          beforeWilliam18: beforeWilliam18,
        };
