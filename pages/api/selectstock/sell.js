...
export default async (req, res) => {
  ...
  if (jsonFiles.indexOf(saveFile) !== -1) {
    ...
    Keys.forEach((key) => {
      ...
      let william9 = williams.getWilliams(macd.slice(-9));
      let william18 = williams.getWilliams(macd.slice(-18));
      let beforeWilliam9 = williams.getWilliams(macd.slice(-10, -1));
      let beforeWilliam18 = williams.getWilliams(macd.slice(-19, -1));
